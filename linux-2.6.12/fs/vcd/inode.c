...
static int find_cd_info_in_toc( struct super_block *sb )
{
	...
	strcat(proc_data_content.cd_type, " DATE 0115\n");
...
root_found:
	...
	*/
	...
	printk("<vcd module> mount disc with vcd module SP OK for VCD/SVCD/Data........0115\n");
	switch (CD_TYPE)
	{
...
//Free that shoud be freed first
	...
	*/
	...
	printk("<vcd module> mount disc with vcd module SP OK for Audio CD........0115\n");
	#ifdef CONFIG_USE_CDDA_SUBCHANNEL
...
#else
	printk("<vcd module> TYPE ACD2352 NO USE CDDA SUBCHANNEL 0115\n");
#endif
