...
#define NET_PBC_STRING	"NET_PBC"
#define USB_AI_UP	"USB_AI_UP"
#define USB_AI_DOWN	"USB_AI_DOWN"
#define USB_AO_UP	"USB_AO_UP"
#define USB_AO_DOWN	"USB_AO_DOWN"
...
extern int unload_module (const char *module_name);
...
extern int create_lockdata(const char *filename);
extern int write_lockdata(const char *filename, const char *data, int len);
extern int write_lockdata_fd(int fd, const char *data, int len);
extern int read_lockdata(const char *filename, char *data, int *len);
extern int testwait_lockdata(const char *filename, const char *data, int len);
