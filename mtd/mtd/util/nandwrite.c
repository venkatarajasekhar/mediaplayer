 ...
 *    #000 2008-10-03 Ken-Yu   Ken add ioctl( , MEMWRITEDATAOOB, ) to do page write one time
 *    #001 2008-10-08 Ken-Yu   add erase before writing in option
 *
 */
...
void process_options (int argc, char *argv[])
{
	...
	for (;;) {
		int option_index = 0;
		static const char *short_options = "os:ajynqpe";
